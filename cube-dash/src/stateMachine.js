const TRANSITIONS = {
  ...
  playing: {COLLISION: 'game_over', PAUSE: 'paused', LEVEL_COMPLETE: 'level_complete'},
  paused: {RESUME: 'playing', QUIT_TO_SELECT: 'level_select'},
  game_over: {ACTION_PRESSED: 'playing'},
  level_complete: {ACTION_PRESSED: 'level_select'},
};

/**
 * @param {string} currentState One of 'title', 'level_select', 'playing',
 *     'paused', 'game_over', 'level_complete'.
 * @param {string} event One of 'ACTION_PRESSED', 'LEVEL_SELECTED',
 *     'COLLISION', 'PAUSE', 'RESUME', 'QUIT_TO_SELECT', 'LEVEL_COMPLETE'.
